...
export class VibeService extends BaseService implements VibeServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public vibeControllerSetLike(likeVibeDto: LikeVibeDto, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public vibeControllerSetLike(likeVibeDto: LikeVibeDto, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public vibeControllerSetLike(likeVibeDto: LikeVibeDto, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public vibeControllerSetLike(likeVibeDto: LikeVibeDto, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (likeVibeDto === null || likeVibeDto === undefined) {
            throw new Error('Required parameter likeVibeDto was null or undefined when calling vibeControllerSetLike.');
        }
